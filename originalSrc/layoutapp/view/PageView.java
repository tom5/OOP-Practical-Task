...
/**
 * Displays one page and its elements. It implements the View and the Controller patrs of the
...
public class PageView extends JPanel {
	...
	/** This is the thinkness of the shadow behind the page. */
	...
	public void setCurrentPage(int pageIndex) {
		...
		// Wihtout it, whenever a particular page would be displayed, the
